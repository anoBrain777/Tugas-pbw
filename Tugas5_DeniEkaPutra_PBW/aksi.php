...
if (isset($_POST['tambah'])) {
    ...
    if ($cek_data->num_rows > 0) {
      ...
      // Cek apakah kodemk ada di tabel matakuliah
      $cek_kodemk = $koneksi->query("SELECT * FROM matakuliah WHERE kodemk='$kodemk'");
      if ($cek_kodemk->num_rows > 0) {
        ...
        echo "Kode MK '$kodemk' tidak ditemukan di tabel matakuliah";
      }
    }
  }
